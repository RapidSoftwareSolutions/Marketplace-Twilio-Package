...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app_bundle.call' => 'getAppBundle_CallService',
            'app_bundle.mms' => 'getAppBundle_MmsService',
            'app_bundle.sms' => 'getAppBundle_SmsService',
    ...
    /**
     * Gets the 'app_bundle.call' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \TwilioBundle\Utils\Call A TwilioBundle\Utils\Call instance
     */
    protected function getAppBundle_CallService()
    {
        return $this->services['app_bundle.call'] = new \TwilioBundle\Utils\Call($this->get('request_stack'), array('required_parameters_missing' => 'Required parameter missing or invalid', 'bad_credentials' => 'Bad credentials'));
    }

    /**
     * Gets the 'app_bundle.mms' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \TwilioBundle\Utils\Mms A TwilioBundle\Utils\Mms instance
     */
    protected function getAppBundle_MmsService()
    {
        return $this->services['app_bundle.mms'] = new \TwilioBundle\Utils\Mms($this->get('request_stack'), array('required_parameters_missing' => 'Required parameter missing or invalid', 'bad_credentials' => 'Bad credentials'));
    }

    /**
     * Gets the 'app_bundle.sms' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \TwilioBundle\Utils\Sms A TwilioBundle\Utils\Sms instance
     */
    protected function getAppBundle_SmsService()
    {
        return $this->services['app_bundle.sms'] = new \TwilioBundle\Utils\Sms($this->get('request_stack'), array('required_parameters_missing' => 'Required parameter missing or invalid', 'bad_credentials' => 'Bad credentials'));
    }
    ...
    {
        return $this->services['cache.app'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('9IqJbS+hUb', 0, (__DIR__.'/pools'));
    }
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('m8HeR+tl5z', 0, '2Vo9RE-nFFlTF2Z9RuG+hg', (__DIR__.'/pools'), NULL);
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bGix653NV5', 0, '2Vo9RE-nFFlTF2Z9RuG+hg', (__DIR__.'/pools'), NULL));
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9r8E7901lG', 0, '2Vo9RE-nFFlTF2Z9RuG+hg', (__DIR__.'/pools'), NULL));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('rjCFzxgqP57e4Uyq');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TwilioBundle' => 'TwilioBundle\\TwilioBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appDevDebugProjectContainer',
            'app_bundle.packagename' => 'Twilio',
            'app_bundle.metadata' => array(
                'package' => 'Twilio',
                'tagline' => 'Twilio',
                'description' => 'test',
                'image' => 'test',
